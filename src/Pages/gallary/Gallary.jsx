...
const Gallary = () => {
 ...
 const galleryItems = [
    { id: 1, title: 'Knotless Braids', category: 'Braids', img: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cGVyc29ufGVufDB8fDB8fHww' },
    { id: 2, title: 'Stitch Cornrows', category: 'Cornrows', img: 'https://images.unsplash.com/photo-1620331311520-246422fd82f9?q=80&w=600&auto=format&fit=crop' },
    ...
    { id: 4, title: 'Fulani Inspired Style', category: 'Trending', img: 'https://images.unsplash.com/photo-1601412436009-d964bd02edbc?q=80&w=600&auto=format&fit=crop' },
    { id: 5, title: 'Tribal Feed-in', category: 'Cornrows', img: 'https://images.unsplash.com/photo-1562322140-8baeececf3df?q=80&w=600&auto=format&fit=crop' },
    { id: 6, title: 'Goddess Locs', category: 'Trending', img: 'https://images.unsplash.com/photo-1617396900799-f4ec2b43c7ae?q=80&w=600&auto=format&fit=crop' },
    { id: 7, title: 'Jumbo Box Braids', category: 'Braids', img: 'https://images.unsplash.com/photo-1624224971170-2f84fed5eb5e?q=80&w=600&auto=format&fit=crop' },
    ...
    { id: 9, title: 'Bohemian Passion Twists', category: 'Trending', img: 'https://images.unsplash.com/photo-1580618672591-eb180b1a973f?q=80&w=600&auto=format&fit=crop' },
    { id: 10, title: 'Lemonade Side Braids', category: 'Cornrows', img: 'https://images.unsplash.com/photo-1582095133179-bfd08e2fc6b3?q=80&w=600&auto=format&fit=crop' },
    ...
    { id: 12, title: 'Butterfly Distressed Locs', category: 'Trending', img: 'https://images.unsplash.com/photo-1681387744797-4eb711161586?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8aGFpciUyMHNhbG9uJTIwTWljcm8lMjBUcmlhbmdsZSUyMEJyYWlkc3xlbnwwfHwwfHx8MA%3D%3D' },
    ...
    { id: 14, title: 'Zig-Zag Stitch Lines', category: 'Cornrows', img: 'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fHBlcnNvbnxlbnwwfHwwfHx8MA%3D%3D' },
    ...
    { id: 16, title: 'Chunky Flat Twists', category: 'Cornrows', img: 'https://images.unsplash.com/photo-1593104547489-5cfb3839a3b5?q=80&w=600&auto=format&fit=crop' },
    { id: 17, title: 'Honey Blonde Box Braids', category: 'Braids', img: 'https://images.unsplash.com/photo-1499952127939-9bbf5af6c51c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHBlcnNvbnxlbnwwfHwwfHx8MA%3D%3D' },
    { id: 18, title: 'Curly Ends Cornrows', category: 'Trending', img: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fHBlcnNvbnxlbnwwfHwwfHx8MA%3D%3D' }
  ];
